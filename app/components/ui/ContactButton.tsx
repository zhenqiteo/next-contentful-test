...
const ContactButton = () => {
  return (
    <Link href="/contact-us" className="max-lg:hidden" aria-label="Contact Us">
      <button className="group cursor-pointer border-opacity-0 bg-white-200 transition-all duration-500 hover:border-opacity-100 text-light font-medium max-w-fit rounded-full border-white/50 hover:border-white hover:text-white border-[2px] p-[2px]">
