...
const ContactButton = () => {
  return (
    ...
    >
      <button className="group cursor-pointer border-opacity-0 bg-transparent transition-all duration-500 hover:border-opacity-100 text-light font-medium max-w-fit rounded-full border-white/50 hover:border-white hover:text-white border-[1px] p-[2px]">
